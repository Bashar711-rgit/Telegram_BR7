...
🚨 THE CONTRACT: the user-facing alert output must be byte-identical
before and after the Sender Intelligence work. These tests pin the
EXACT expected strings produced by the pre-change code (captured via
scripts/golden_alert_baseline.py at commit 250a769, before v9.9).

If ANY of these tests fail, the alert format changed and the release
must be considered broken. Same for buttons: labels, order, URLs and
callback data are all verified.
"""
...
# ── GOLDEN OUTPUT (captured from the pre-v9.9 code) ──────────────────────
GOLDEN = {
    "S1_username_chat": {
        "alert": (
        ...
        "buttons": [
            [
                ...
                ("KeyboardButtonUrl", "👤 فتح الحساب", "tg://user?id=555000111", None),
    ...
    "S2_private_chat": {
        ...
        "buttons": [
            [
                ("KeyboardButtonUrl", "👤 فتح الحساب", "tg://user?id=777000222", None),
                ("KeyboardButtonCallback", "📋 نسخ النص", None, "copy_abc123"),
            ]
        ],
    },
    "S3_no_username_hash": {
        ...
        "buttons": [
            [
                ("KeyboardButtonUrl", "👤 فتح الحساب", "tg://user?id=888000333", None),
                ("KeyboardButtonCallback", "📋 نسخ النص", None, "copy_abc123"),
            ]
        ],
    },
    "S4_unknown_title": {
        ...
        "buttons": [
            [
                ...
                ("KeyboardButtonUrl", "👤 فتح الحساب", "tg://user?id=999000444", None),
                ("KeyboardButtonCallback", "📋 نسخ النص", None, "copy_abc123"),
            ]
        ],
    },
...
class TestAlertRegression:
    ...
    async def test_s1_username_chat(self, monitor):
        ...
        chat = {"group_link": "https://t.me/mygroup", "title": "مجموعة الطلاب", "msg_link": "https://t.me/mygroup/123"}
    ...
    async def test_s2_private_chat(self, monitor):
        ...
        chat = {"group_link": "https://t.me/c/1234567890", "title": "مجموعة خاصة", "msg_link": "https://t.me/c/1234567890/456"}
        alert, buttons = monitor._build_alert(sender, chat, "واجب", TEXT, {"msg_hash": "abc123"})
    ...
    async def test_s4_unknown_title(self, monitor):
        ...
        chat = {"group_link": "https://t.me/eng_group", "title": "غير معروف", "msg_link": "https://t.me/eng_group/789"}
        alert, buttons = monitor._build_alert(sender, chat, "واجب", TEXT, {"msg_hash": "abc123"})
    ...
    async def test_buttons_contract_config(self):
        """The alert-button contract flags must be untouched by v9.9."""
